        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm">
              IELTS Reading bo'limi bo'yicha to'liq kurs
            </p>
          </div>
        </div>
      </motion.div>
                  ...
                  {lesson.isPremium ? (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3 text-xs text-gray-500 mb-3">
                        ...
                        {lesson.videoUrl && (
                          <span className="flex items-center gap-1 text-indigo-500" title="Video dars">
